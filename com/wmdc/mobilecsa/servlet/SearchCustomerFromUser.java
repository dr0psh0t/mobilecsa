...
public class SearchCustomerFromUser extends HttpServlet {
    ...
    private void procRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Utils.printJsonException(new JSONObject(), "Cannot search customer at this time.", out);
            Utils.displayStackTraceArray(sqe.getStackTrace(), Utils.SERVLET_PACKAGE, "DBException", sqe.toString(),
                    ctx, conn);

        } catch (Exception e) {
            Utils.printJsonException(new JSONObject(), "Cannot search customer at the moment.", out);
