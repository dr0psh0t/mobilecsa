...
public class ActivateUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!checkParameters(lockedUsername, password, retypePassword, username, responseJson, out, ctx)) {
                return;
            }
            ...
            Utils.printJsonException(new JSONObject(), "Cannot activate user at this time.", out);

            Utils.displayStackTraceArray(sqe.getStackTrace(), Utils.SERVLET_PACKAGE, "DBException", sqe.toString(), ctx,
                    conn);
        } catch (Exception e) {
            Utils.printJsonException(new JSONObject(), "Cannot activate user at the moment.", out);
    ...
    public boolean checkParameters(String lockedUsername, String password, String retypePassword, String username,
