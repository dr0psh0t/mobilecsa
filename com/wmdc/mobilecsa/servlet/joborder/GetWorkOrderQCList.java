 ...
 */
@WebServlet("/getworkorderqclist")
public class GetWorkOrderQCList extends HttpServlet {
    private String getWoQcList(ServletContext context) {
        ...
        try {
            ...
            prepStmt.setString(1, "getwoqclist_servlet");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String servlet = getWoQcList(ctx);
        ...
        try {
            ...
            conn.setRequestProperty("Referer", "getdatecommittest");
            ...
            if (statusCode == HttpURLConnection.HTTP_OK) {
                ...
                if (serverResponse.isEmpty()) {
                    Utils.printJsonException(resJson, "Server response is empty.", out);
                    return;
                }
            ...
            Utils.printJsonException(new JSONObject(), "Cannot get workorder list at this time.", out);
            Utils.displayStackTraceArray(sqe.getStackTrace(), Utils.JOBORDER_PACKAGE, "NetworkException",
                    sqe.toString(), ctx, null);

        } catch (Exception e) {
            Utils.printJsonException(new JSONObject(), "Cannot get workorder list at the moment.", out);
